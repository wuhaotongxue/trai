...
import { FileText, PlusCircle, Wrench, Bug, RefreshCw, FileCode } from "lucide-react";
            ...
            <div className="max-w-4xl space-y-12">
              {changelogData.map((release, idx) => (
                <div key={idx} className="relative pl-0 md:pl-8">
                  ...
                  {/* 版本详情内容 */}
                  <div className="bg-white dark:bg-[#0d1220] border border-slate-200 dark:border-slate-800/60 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
