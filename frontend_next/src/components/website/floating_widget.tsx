...
export function FloatingWidget() {
  ...
  return (
    <>
      ...
      {isChatOpen && (
        <div className="fixed bottom-24 right-8 z-50 w-[400px] h-[600px] bg-background border border-border rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-10 fade-in duration-300">
