...
export function Sidebar() {
  ...
  return (
    <div className="w-72 h-full bg-white dark:bg-slate-900 border-r-4 border-slate-900 dark:border-white flex flex-col transition-all duration-300">
      <div className="p-6 border-b-4 border-slate-900 dark:border-white bg-amber-400">
        <Button 
        ...
        >
          <div className="w-8 h-8 border-2 border-slate-900 shadow-[2px_2px_0px_0px_#0f172a] flex items-center justify-center bg-emerald-400">
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      sessionId === session.session_id 
                        ? "bg-cyan-400 text-slate-900 border-slate-900 shadow-[4px_4px_0px_0px_#0f172a]" 
                  ...
                  >
                    ...
                    {editingId === session.session_id ? (
                      <div className="flex-1 flex items-center gap-2 min-w-0" onClick={e => e.stopPropagation()}>
                        ...
                        />
                        <button onClick={() => handleRename(session.session_id)} className="p-2 border-2 border-slate-900 bg-emerald-400 shadow-[2px_2px_0px_0px_#0f172a] hover:bg-emerald-300 text-slate-900">
                          <Check className="h-4 w-4" />
                        </button>
                        <button onClick={() => setEditingId(null)} className="p-2 border-2 border-slate-900 bg-rose-400 shadow-[2px_2px_0px_0px_#0f172a] hover:bg-rose-300 text-slate-900">
                          <X className="h-4 w-4" />
                        </button>
                      </div>
                    ) : (
                    ...
                    {!editingId && (
                      <div className="absolute right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                        <DropdownMenu>
                          <DropdownMenuTrigger onClick={e => e.stopPropagation()} className="p-1 border-2 border-transparent hover:border-slate-900 hover:bg-amber-400 hover:shadow-[2px_2px_0px_0px_#0f172a] transition-all text-slate-900">
                          ...
                          <DropdownMenuContent align="end" className="w-40 border-4 border-slate-900 shadow-[8px_8px_0px_0px_#0f172a] bg-white rounded-none p-0">
                            ...
                            }} className="p-3 font-bold text-slate-900 uppercase tracking-widest hover:bg-emerald-400 cursor-pointer rounded-none border-b-2 border-slate-900">
                              <Edit2 className="h-5 w-5 mr-3" />
                              重命名
                            </DropdownMenuItem>
                            <DropdownMenuItem 
                              className="p-3 font-bold text-slate-900 uppercase tracking-widest hover:bg-rose-400 cursor-pointer rounded-none"
