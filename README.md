...
### 🛠️ 系统更新_2026_04_25_0140
- **样式（Electron）**: 统一界面背景色为白色，移除灰色变量 `--ui_bg`、`--ui_panel_alt`
- **文档（项目）**: 新增错误日志模块 `md/error_logs/`，记录 Agent 犯过的错误与改进
- **技能**: 更新 git_submit 技能，添加 20 种中文 commit 类型和 7 种领域标签
- **技能**: 新增 error_logs 技能规范，记录格式要求
