...
<div style="background:#f8fafc;border:1px dashed #94a3b8;border-radius:8px;padding:10px 14px;margin:12px 0;font-family:ui-monospace,monospace;font-size:0.88em;color:#475569;">
  <strong>时间锚点</strong> <code style="background:#e2e8f0;padding:2px 6px;border-radius:4px;color:#0f172a;">md/issue_XX/index.md</code>
  <div style="margin-top:6px;padding-top:6px;border-top:1px dashed #cbd5e1;">
    📋 <strong>上期节点</strong>: <a href="https://gitee.com/no5689/trai/commit/上期首次创建提交哈希" target="_blank" style="color:#2563eb;">Gitee</a> | <a href="https://github.com/wuhaotongxue/trai/commit/上期首次创建提交哈希" target="_blank" style="color:#2563eb;">GitHub</a> · <code style="background:#e2e8f0;padding:2px 6px;border-radius:4px;color:#0f172a;">短哈希</code> · YYYY-MM-DD HH:MM:SS +0800
  </div>
  <div style="margin-top:6px;">
    🎯 <strong>本期节点</strong>: <a href="https://gitee.com/no5689/trai/commit/本期首次创建提交哈希" target="_blank" style="color:#2563eb;">Gitee</a> | <a href="https://github.com/wuhaotongxue/trai/commit/本期首次创建提交哈希" target="_blank" style="color:#2563eb;">GitHub</a> · <code style="background:#e2e8f0;padding:2px 6px;border-radius:4px;color:#0f172a;">短哈希</code> · YYYY-MM-DD HH:MM:SS +0800
  </div>
  <div style="margin-top:6px;">
    📐 <strong>本期范围</strong>: <code style="background:#e2e8f0;padding:2px 6px;border-radius:4px;color:#0f172a;">git log 上期短哈希..本期短哈希</code>
  </div>
</div>
```

**填写规则**:
- **上期节点**: 使用 `git log --oneline -- md/issue_XX/index.md | Select-Object -Last 1` 获取上期首次创建提交哈希和时间
- **本期节点**: 使用 `git log --oneline -- md/issue_XX/index.md | Select-Object -Last 1` 获取本期首次创建提交哈希和时间
- 时间格式: `YYYY-MM-DD HH:MM:SS +0800`（东八区时间）
- **本期范围**: 使用 `git log 上期短哈希..本期短哈希` 查看从上期到本期的代码变更
- 每期都要正确指向前一期和本期的首次创建提交, 体现周迭代范围
