---
name: "frontend_next"
description: "Frontend Next 规范与审查入口。修改 frontend_next 或新增页面/路由/组件时调用，按 App Router、TS/Tailwind/i18n 等规范检查。"
---
...
### 2. TypeScript 5.x + Next.js 15 环境
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;padding:16px;background:#F9F9F9;border-radius:12px;margin:12px 0;">
  ...
  <div style="background:white;border:1px solid #E1E1E1;border-radius:8px;padding:12px;text-align:center;">
    <strong style="font-size:13px;color:#D32F2F;">组件行数限制</strong>
    <div style="font-size:12px;color:#666;margin-top:4px;">建议 <= 200 行</div>
  </div>
