...
|---------|------|---------|------|--------|
| VR-REC-001 | 视频录制需用户确认 | tool_call: video.recording.start | require_confirmation | error |
| VR-REC-002 | 录制开始通知所有参会者 | action: video_recording_started | notify_all_participants | info |
| VR-REC-003 | 录制停止通知所有参会者 | action: video_recording_stopped | notify_all_participants | info |
