...
from trai.domain.entities.chat_session import ChatSession, SessionStatus
from trai.infrastructure.ai.openai_client import OpenAIClient
from trai.infrastructure.repositories.session_repository import (
    MessageRepository,
    SessionRepository,
)
from trai.infrastructure.database.database import get_session
