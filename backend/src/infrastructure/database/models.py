...
class ChatSessionModel(Base):
    ...
    t_session_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="会话唯一标识 UUID"
    )
...
class QuotaPlanModel(Base):
    ...
    t_user_role: Mapped[str] = mapped_column(
        String(20), unique=True, nullable=False, index=True, comment="用户角色:admin/vip/normal/guest"
    )
    t_image_generation_limit: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="图片生成配额(0 表示无限制)"
    )
    t_audio_synthesis_limit: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="语音合成配额(0 表示无限制)"
    )
    t_transcription_minutes_limit: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="语音转录配额(分钟)"
    )
    ...
    t_agent_tool_call_limit: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="Agent 工具调用配额(0 表示无限制)"
    )
    t_created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now, comment="创建时间")
    t_created_by: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="创建人 user_id")
    t_updated_at: Mapped[datetime] = mapped_column(
...
class UserQuotaUsageModel(Base):
    ...
    t_transcription_minutes_used: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="语音转录已用分钟数"
    )
    ...
    t_agent_tool_call_used: Mapped[int] = mapped_column(
        Integer, default=0, nullable=False, comment="Agent 工具调用已用次数"
    )
    t_created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now, comment="创建时间")
    t_created_by: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="创建人 user_id")
    t_updated_at: Mapped[datetime] = mapped_column(
...
class QuotaTransactionLogModel(Base):
    ...
    t_user_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True, comment="用户 ID")
    t_billing_month: Mapped[str] = mapped_column(String(7), nullable=False, index=True, comment="账单月份 YYYY-MM")
    t_transaction_type: Mapped[str] = mapped_column(
        String(20), nullable=False, comment="交易类型:deduct/reset/grant/purchase"
    )
...
class ImageGenerationModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="任务唯一标识 UUID"
    )
    t_user_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True, comment="用户 ID")
    ...
    t_status: Mapped[str] = mapped_column(
        String(32),
        default="pending",
        nullable=False,
        index=True,
...
class UploadTaskModel(Base):
    ...
    t_status: Mapped[str] = mapped_column(
        String(32), default="pending", nullable=False, index=True, comment="任务状态:pending/uploading/completed/failed"
    )
...
class ClientReleaseModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_version: Mapped[str] = mapped_column(
        String(32), unique=True, nullable=False, index=True, comment="版本号,例如 0.1.0"
    )
...
class AuditLogModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_log_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="日志唯一标识 UUID"
    )
...
class ContactMessageModel(Base):
    ...
    t_type: Mapped[str] = mapped_column(
        String(50), nullable=False, comment="咨询类型:presale/tech/business/purchase/channel/other"
    )
    ...
    t_status: Mapped[str] = mapped_column(
        String(20), default="pending", nullable=False, index=True, comment="处理状态:pending/processed/replied"
    )
    ...
    t_submission_id: Mapped[str | None] = mapped_column(
        String(36), nullable=True, unique=True, comment="提交唯一标识 UUID"
    )
    t_created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now, comment="创建时间")
    t_updated_at: Mapped[datetime] = mapped_column(
...
class EmailConfigModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_config_name: Mapped[str] = mapped_column(
        String(100), unique=True, nullable=False, comment="配置名称:contact_notify/system_notify/alert"
    )
...
class AgentRoleModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_role_name: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="角色名称,如:地理专家/小甜心/御姐"
    )
    t_role_comment: Mapped[str] = mapped_column(Text, nullable=False, comment="角色专属评论,发布通知时显示")
    t_role_keyword: Mapped[str | None] = mapped_column(
        String(255), nullable=True, comment="触发关键词,逗号分隔,如:地理,专家,经纬度"
    )
    t_style_type: Mapped[str] = mapped_column(
        String(32), default="default", comment="风格类型:甜美可爱/御姐型/软萌撒娇/知性温柔/活泼开朗"
    )
...
class ChatLogModel(Base):
    ...
    t_session_id: Mapped[str | None] = mapped_column(
        String(64), nullable=True, index=True, comment="关联的会话 session_id"
    )
    t_user_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True, comment="用户 ID")
    t_username: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="用户姓名/昵称")
    t_level: Mapped[str] = mapped_column(
        String(20), nullable=False, index=True, comment="日志级别:debug/info/warning/error/critical"
    )
...
class ImageRecordModel(Base):
    ...
    t_record_type: Mapped[str] = mapped_column(
        String(32), nullable=False, index=True, comment="记录类型: text_to_image / image_to_image / image_edit"
    )
    ...
    t_request_ip: Mapped[str | None] = mapped_column(
        String(50), nullable=True, comment="请求来源 IP（可能与 client_ip 不同）"
    )
    t_user_agent: Mapped[str | None] = mapped_column(String(500), nullable=True, comment="浏览器 User-Agent")
    ...
    t_source_image_url_2: Mapped[str | None] = mapped_column(
        Text, nullable=True, comment="第二张源图片 URL（双图联动编辑）"
    )
    t_source_image_object_key: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="源图片 S3 对象键"
    )
    t_source_image_object_key_2: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="第二张源图片 S3 对象键（双图联动编辑）"
    )
    t_result_url: Mapped[str | None] = mapped_column(Text, nullable=True, comment="结果图片 S3 URL")
    t_result_base64: Mapped[str | None] = mapped_column(
        Text, nullable=True, comment="结果图片 base64（临时存储，存入 S3 后清空）"
    )
    t_status: Mapped[str] = mapped_column(
        String(32),
        default="pending",
    ...
    t_notify_status: Mapped[str] = mapped_column(
        String(20), default="pending", nullable=False, comment="通知状态: pending / success / failed"
    )
...
class MusicRecordModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="音乐任务唯一标识"
    )
    ...
    t_status: Mapped[str] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="任务状态, 如 queued processing completed failed",
    )
    ...
    t_duration_seconds: Mapped[float] = mapped_column(
        Float, default=30.0, nullable=False, comment="目标音频时长, 单位秒"
    )
...
class VideoDownloadModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="下载任务唯一标识"
    )
    ...
    t_status: Mapped[str] = mapped_column(
        String(32), default="completed", nullable=False, comment="下载状态: completed / failed"
    )
...
class VideoRecordModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="视频任务唯一标识"
    )
    t_user_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True, comment="创建任务的用户 ID")
    t_username: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="创建任务的用户名")
    t_client_ip: Mapped[str | None] = mapped_column(String(50), nullable=True, index=True, comment="请求来源 IP")
    ...
    t_inference_time_seconds: Mapped[int | None] = mapped_column(
        Integer, nullable=True, comment="模型纯推理耗时, 单位秒"
    )
...
class LoginLogModel(Base):
    ...
    t_login_status: Mapped[str] = mapped_column(
        String(20), nullable=False, index=True, comment="登录状态:success/failure"
    )
    ...
    t_user_agent: Mapped[str | None] = mapped_column(Text, nullable=True, comment="浏览器 User-Agent")
    t_device_type: Mapped[str | None] = mapped_column(
        String(50), nullable=True, comment="设备类型:desktop/mobile/tablet"
    )
...
class AudioRecordModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="音频任务唯一标识"
    )
    t_user_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True, comment="创建任务的用户 ID")
    t_username: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="创建任务的用户名")
    t_task_type: Mapped[str] = mapped_column(
        String(32),
        nullable=False,
        comment="任务类型: separation(人声分离), clone(声音克隆), conversion(格式转换), asr(语音识别)",
    )
    t_status: Mapped[str] = mapped_column(
        String(32), default="processing", nullable=False, comment="任务状态: processing, completed, failed"
    )
    ...
    t_updated_at: Mapped[datetime] = mapped_column(
        DateTime, default=datetime.now, onupdate=datetime.now, comment="任务最后更新时间"
    )
...
class MeetingRecordModel(Base):
    ...
    t_id: Mapped[int] = mapped_column(Integer, primary_key=True, comment="自增主键 ID")
    t_task_id: Mapped[str] = mapped_column(
        String(64), unique=True, nullable=False, index=True, comment="会议记录唯一标识"
    )
    ...
    t_status: Mapped[str] = mapped_column(
        String(32), default="processing", nullable=False, comment="处理状态: processing, completed, failed"
    )
    ...
    t_updated_at: Mapped[datetime] = mapped_column(
        DateTime, default=datetime.now, onupdate=datetime.now, comment="记录最后更新时间"
    )
