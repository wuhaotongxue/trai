...
from sqlalchemy import String, Boolean, DateTime, func, JSON, Integer
...
class AudioTranscribeRecordModel(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), default="processing", nullable=False, comment="状态 (processing, success, failed)")
    ...
    updated_at: Mapped[datetime] = mapped_column(DateTime(0), server_default=func.current_timestamp(0), onupdate=func.current_timestamp(0), nullable=False, comment="更新时间")
