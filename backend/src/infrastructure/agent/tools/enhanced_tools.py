...
class WebSearchTool(BaseTool):
    ...
    async def _duckduckgo_search(self, query: str, num: int) -> list[dict]:
        ...
        try:
            ...
            return [
                {"title": f"搜索结果: {query}", "url": "", "snippet": f"关于'{query}'的模拟搜索结果.请安装duckduckgo_search包以启用真实搜索."},
            ]
...
class DateTimeTool(BaseTool):
    ...
    parameters = [
        ToolParameter("timezone", "string", "时区,如 'Asia/Shanghai', 'UTC', 'America/New_York'", default="Asia/Shanghai"),
...
__all__ = [
    "BaseTool", "EnhancedToolRegistry",
    "WebSearchTool", "CalculatorTool", "CodeExecutorTool",
    "DateTimeTool", "TextAnalysisTool", "JSONFormatterTool",
    "ToolCategory", "ToolParameter", "ToolResult",
    "register_default_tools",
]
