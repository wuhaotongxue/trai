    ...
    async def execute(self, params: dict[str, Any], context: ExecutionContext) -> ToolCallResult:
        ...
        if not video_path_str:
            return ToolCallResult(
                tool_call_id=str(uuid.uuid4()), tool_id=self.definition.id, success=False, error="video_path 不能为空"
            )
        ...
        try:
            ...
            return ToolCallResult(tool_call_id=task_id, tool_id=self.definition.id, success=False, error=str(e))
