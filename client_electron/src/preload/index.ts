...
contextBridge.exposeInMainWorld('electron_api', {
  ...
  tools_convert_image: (file_path: string, target_format: string, sizes?: number[], width?: number, height?: number) => ipcRenderer.invoke('tools:convert_image', file_path, target_format, sizes, width, height),
